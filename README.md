...
<ul dir="auto">
<li>Frontend Developer | HTML | CSS | JS | TS | Angular </li>
...
-->
<em>
Iniciei minha trajetória como Design/UX & UI. Em 2021 iniciei os estudos e a Graduação em Gestão da Tecnologia. Desde então, venho trabalhando com desenvolvimento frontend, sempre preocupadocom a Experiência do Usuário.
</em>
...
<li>🌠 UI/UX Designer Adobe collaborator. </li>
</ul>
...
<ul dir="auto">
<li>
  ⭐ MyRepsApp, sistema responsivo e de fácil usabilidade, oferece aos alunos uma maneira fácil e convidativa de marcar e acompanhar seus horários. Neste projeto utilizamos o padrão de arquitetura MVC, conceitos de estado da IU, JAVA e uma fonte de dados SQL. 
</li> 
<li>
...
<li>
  ⭐ DedicateWeb, página de busca que traz uma nova experiência para os médicos e para todos os clientes que utilizam a web para marcar consultas. Durante o projeto atuei como Ux&Ui utilizando bastante ferramentas de prototipação, e frontend com HTML, CSS e JavaScript. 
</li>
</ul>
